...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_app2.default, { username: 'Ocramius', perPage: 8 }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repositories = function (_Component) {
	  ...
	  function Repositories(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Repositories).call(this, props));
	    ...
	    _this.mostActive = ['Ocramius', 'brianchandotcom', 'taylorotwell', 'GrahamCampbell', 'michalbe'];
	  ...
	  _createClass(Repositories, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'username', onSubmit: this.handleUserSubmit.bind(this) },
	          _react2.default.createElement('input', { type: 'text', value: username, onChange: this.handleUserChange.bind(this) }),
	          _react2.default.createElement(
	            'button',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            'Most active: ',
	            this.mostActive.map(function (u) {
	              return _react2.default.createElement(
	                'a',
	                { key: u, className: 'active-user', href: '', onClick: _this2.setUser.bind(_this2, u) },
	                u
	              );
	            })
	          )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'ul',
	            null,
	            subRepos.map(function (r) {
	              return _react2.default.createElement(
	                'li',
	                { target: '_blank', key: r.id },
	                _react2.default.createElement(
	                  'a',
	                  { href: r.html_url },
	                  r.name
	    ...
	    value: function renderPagination() {
	      ...
	      var totalPages = _state2.totalPages;
	      ...
	      for (var i = 1; i <= totalPages; i++) {
	        pages.push(_react2.default.createElement(
	          ...
	          {
	            key: i,
	            className: (0, _classnames2.default)({ active: i === currentPage }),
	    ...
	    key: 'setUser',
	    value: function setUser(username, e) {
	    ...
	    value: function fetchRepos(user) {
	      ...
	      this.request = _jquery2.default.get('https://api.github.com/users/' + user + '/repos');

	      this.setState({
	        loading: true
	      });

	      this.request.then(function (repos) {
	    ...
	    value: function resetPagination() {
	      ...
	      var totalPages = Math.ceil(repos.length / perPage);
	      var subRepos = repos.slice(0, perPage);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
		...
		} else if ("function" === 'function' && _typeof(__webpack_require__(167)) === 'object' && __webpack_require__(167)) {
